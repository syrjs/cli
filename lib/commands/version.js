...
var cmd = function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(parameters, switches) {
...
var api = {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 15:
              ...
              // new version
              _logger.log.info(`Creating new version ${_npm.project.version}`);
              _context.next = 20;
              return _versions.Manager.createVersion(_npm.project.version);
            ...
            case 24:
              _logger.log.error(`package.json version ${_npm.project.version} does not match syr.json currentProject ${currentVersion.semver}.`);
              _context.next = 27;
              return _inquirer2.default.prompt([{
                type: 'list',
                name: 'result',
                message: `Switch current project in syr.json to ${_npm.project.version}?`,
            ...
            case 33:
              _logger.log.warn('current syr project version, and current npm project version do not match, becareful.');
  ...
  switchVersion: function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(versionTag) {
  ...
  checkForVersion: function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(versionTag) {
      var version;
