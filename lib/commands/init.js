...
var description = {
  short: _strings2.default.get('Creates a new project using boilerplate. Includes native projects to get started'),
...
function checkForPackageJSON() {
  ...
  try {
    projectPackage = require(`${_path2.default.join(process.cwd(), 'package.json')}`);
  } catch (e) {}
  if (projectPackage) {
