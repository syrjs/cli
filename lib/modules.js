...
function findModules(modulesPath) {
  ...
  if (namespaces.length > 0) {
    namespaces.forEach(function (namespace) {
      var submodules = findModules(_path2.default.join(modulesPath, namespace)).map(function (value, index) {
...
function checkModule(modulePath, moduleDirectory) {
  ...
  if (modulePackage && modulePackage.dependencies && modulePackage.dependencies['@syr/core']) {
    return true;
  }
